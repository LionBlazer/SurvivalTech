...
public static final ArrayList<MultiBlock> multiblocks = new ArrayList<MultiBlock>();
	...
	@SideOnly(Side.CLIENT)
	public static void registerRenderModel(Item item, String model) {
		Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(item, 0, new ModelResourceLocation("&IJAVAMODEL&_"+model, "inventory"));
	}
