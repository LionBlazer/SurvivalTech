...
public class MaterialRegister {
    ...
    public static void init() {
        ...
        SmallArcFurnaceRecipe.RECIPES.add(new SmallArcFurnaceRecipe(Arrays.asList(new ItemStack(GameMaterialRegister.small_iron.getItemsMaterial().get(0))), Arrays.asList(new ItemStack(Items.IRON_NUGGET, 8)), 2000));
        SmallArcFurnaceRecipe.RECIPES.add(new SmallArcFurnaceRecipe(Arrays.asList(new ItemStack(GameMaterialRegister.copper.getItemsMaterial().get(2), 4)), Arrays.asList(new ItemStack(GameMaterialRegister.copper.getItemsMaterial().get(1), 1)), 200));
        SmallArcFurnaceRecipe.RECIPES.add(new SmallArcFurnaceRecipe(Arrays.asList(new ItemStack(GameMaterialRegister.tin.getItemsMaterial().get(1), 4)), Arrays.asList(new ItemStack(GameMaterialRegister.tin.getItemsMaterial().get(0), 1)), 200));
        SmallArcFurnaceRecipe.RECIPES.add(new SmallArcFurnaceRecipe(Arrays.asList(new ItemStack(GameMaterialRegister.tin.getOresBlock().get(0))), Arrays.asList(new ItemStack(GameMaterialRegister.tin.getItemsMaterial().get(0), 2)), 300));

        SmallArcFurnaceRecipe.RECIPES.add(new SmallArcFurnaceRecipe(Arrays.asList(new ItemStack(GameMaterialRegister.tin.getOresBlock().get(1))), Arrays.asList(new ItemStack(GameMaterialRegister.tin.getItemsMaterial().get(1), 3)), 3000));

        SmallArcFurnaceRecipe.RECIPES.add(new SmallArcFurnaceRecipe(Arrays.asList(

                new ItemStack(Blocks.SAND), new ItemStack(GameMaterialRegister.copper.getOresBlock().get(0))), Arrays.asList(new ItemStack(GameMaterialRegister.copper.getItemsMaterial().get(2)), new ItemStack(GameMaterialRegister.small_iron.getItemsMaterial().get(0))), 200));
