package ru.whitewarrior.survivaltech.registry.render.entity;
...
public class RenderSpaceship extends Render<EntityRocket> {
    ...
    public void doRender(EntityRocket entity, double x, double y, double z, float entityYaw, float partialTicks) {
       super.renderLivingLabel(entity, "TEST", x,y,z, 100);
