...
public class ItemToolBakedModel implements IBakedModel {
    List<BakedQuad> quads;
    TextureAtlasSprite textureAtlasSprite;

    public ItemToolBakedModel(List<BakedQuad> quads, TextureAtlasSprite textureAtlasSprite) {
        this.quads = quads;
    ...
    public ItemCameraTransforms getItemCameraTransforms() {
        ItemTransformVec3f thirdPerson = new ItemTransformVec3f(new Vector3f(0f, -90, 45), new Vector3f(0.005f, 0.15f, 0.04f), new Vector3f(0.85f, 0.85f, 0.85f));
