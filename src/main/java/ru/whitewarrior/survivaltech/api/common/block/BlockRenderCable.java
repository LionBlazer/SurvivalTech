...
public abstract class BlockRenderCable extends BlockCable  {
	...
	public BlockRenderCable(Material materialIn) {
		super(materialIn);
        this.setDefaultState(getBlockState().getBaseState().withProperty(DOWN, false).withProperty(UP, false).withProperty(NORTH, false).withProperty(SOUTH, false).withProperty(WEST, false).withProperty(EAST, false));
	}
